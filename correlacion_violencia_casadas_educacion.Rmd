---
title: "Correlacion Violencia | Nivel de educacion"
...
persona <- EPCVCM_Persona %>% select(folio, s2_02, s2_09, s3_01) %>% filter(s2_02 == 2 & (s2_09 == 1 | s2_09 == 2)) 
...
matrix_N <- matrix_N[,-c(1:10)] %>% na.omit(matrix_N)

# Verificando que no existan columnas con 0 observaciones
apply(matrix_N, 2, sum)
attributes(matrix_N)$names
matrix_N <- matrix_N[,-c(31)]

table(data[, variables[1:9]])
...
labels <- c("Pertenece a pueblo indigena", 
            ...
            "Primaria (Actual)", 
            "Secundaria (Actual)", 
            "Centro de educacion media de adultos",
            "Educacion juvenil alterna", 
            "Normal - Escuela de maestros",
            "Universidad",
            "Diplomado", 
            "Maestria", 
            "Doctorado", 
            ...
            "Tecnico Instituto", 
            "Instituto de formación militar", 
            "Humillacion = NO", 
            "Humillacion = SI", 
            "Amenazas = NO", 
            "Amenazas = SI", 
